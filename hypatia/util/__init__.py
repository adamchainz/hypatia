...
class PersistentHashTable(Persistent, collections.MutableMapping):
    """ A persistent hash table implementation; useful instead of an OxBTree
    for collections that have keys which cannot support total ordering. Really
    bad at collections where hash collisions are common, however."""
    family = BTrees.family64
